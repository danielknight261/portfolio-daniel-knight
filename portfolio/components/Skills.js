...
const Skills = () => {
  return (
    <div id='skills' className='w-fill lg:h-screen p-2 bg-[#ffffba]'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-110 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <img
                  src='https://i.ibb.co/28tWVVN/css.png'
                  width='64px'
                  height='64px'
                  alt='/'
                />
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-110 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
              <img
                  src='https://i.ibb.co/whDRRxQ/Mongodb-PNG-Image-HD.png'
                  width='64px'
                  height='64px'
                  alt='/'
                />
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-110 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
              <img
                  src='https://i.ibb.co/hgbC41n/download.png'
                  width='64px'
                  height='64px'
                  alt='/'
                />
