...
const Contact = () => {
  return (
    <div id='contact' className='w-screen lg:h-screen bg-[#ffb3ba]'>
      <div className='max-w-[1240px] m-auto px-2 py-16 w-full'>
        <p className='text-xl tracking-widest uppercase text-[#166c96]'>
            Contact
        </p>
...
<div className='col-span-3 lg:col-span-2 w-full shadow-xl shadow-gray-400 rounded-xl p-4'>
 <div className='lg:p-4 h-full'>
    <div>
        <img className='rounded-xl hover:scale-105 ease-in duration-300' src='https://ninthbinary.com/media/2020/02/Contact_us.gif' alt='/' />
    </div>
    <div>
    ...
    <div className='flex items-center justify-between max-w-[280px] m-auto py-4'>
...
<HiOutlineChevronDoubleUp className='text-[#1b2651]' size={25}/>
       </div>
    </Link>
  </div>
 </div>
